import { Chapter, LanguageCode, Manga, MangaTile, Tag, TagSection, MangaUpdates } from 'paperback-extensions-common'
...
export class Parser {
  ...
  parseSearchResults($: CheerioAPI): MangaTile[] {
  ...
  parseFeaturedSection($: CheerioAPI): MangaTile[] {
    ...
    for (let manga of $('div.item', 'div.altcontent1').toArray()) {
      ...
      const subtitle =
        $('.slide-caption > a', manga).text().trim() + ' - ' + $('.slide-caption > .time', manga).text().trim()
      if (!id || !title) continue
      featuredItems.push(
        createMangaTile({
          id: id,
  ...
  parsePopularSection($: CheerioAPI): MangaTile[] {
  ...
  parseHotSection($: CheerioAPI): MangaTile[] {
  ...
  parseNewUpdatedSection($: CheerioAPI): MangaTile[] {
  ...
  parseNewAddedSection($: CheerioAPI): MangaTile[] {
  ...
  parseFullSection($: CheerioAPI): MangaTile[] {
  ...
  parseViewMoreItems($: CheerioAPI): MangaTile[] {
  ...
  parseUpdatedManga(updateManga: CheerioAPI, time: Date, ids: string[]): MangaUpdates {
