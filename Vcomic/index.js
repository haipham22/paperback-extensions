...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Vcomic = exports.VcomicInfo = exports.HomePage = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const VcomicParser_1 = require("./VcomicParser");
const VcomicParser_2 = require("./VcomicParser");
const enum_helper_1 = require("../enum_helper");
const DOMAIN = 'https://vcomic.net';
const method = 'GET';
var HomePage;
(function (HomePage) {
    HomePage["TOP_COMIC"] = "TOP_COMIC";
    HomePage["LAST_UPDATE"] = "LAST_UPDATE";
...
exports.VcomicInfo = {
    ...
    sourceTags: [
        {
            text: enum_helper_1.SourceTagEnum.RECOMMENDED,
...
class Vcomic extends paperback_extensions_common_1.Source {
    ...
    async getChapters(mangaId) {
        ...
        return $('li.row', '.list_chapter', data)
            ...
            return createChapter({
                ...
                time: (0, VcomicParser_1.convertTime)($('.col-xs-4', rawChapter).text().trim()),
            });
        });
    }
    ...
    async getHomePageSections(sectionCallback) {
        ...
        hot.items = $('.item', '.top-comics')
            ...
            return createMangaTile({
                id,
                image: image,
                title: createIconText({ text: (0, VcomicParser_2.decodeHTMLEntity)(title) }),
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        metadata = !(0, VcomicParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
    ...
    async getSearchResults(query, metadata) {
        ...
        const { data } = await this.requestManager.schedule(request, 1);
        let $ = this.cheerio.load(data);
        const tiles = (0, VcomicParser_1.parseSearch)($);
        return createPagedResults({
            results: tiles,
            metadata,
        });
...
},{"../enum_helper":58,"./VcomicParser":57,"paperback-extensions-common":12}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const parseSearch = ($) => {
    const manga = [];
    const collectedIds = [];
    for (let obj of $('li', 'ul').toArray()) {
        const title = $('a h3', obj).text().trim();
        const id = DOMAIN + $('a', obj).attr('href');
        const image = $('img', obj).attr('src');
        const sub = $('i', obj).text().trim();
        if (!collectedIds.includes(id)) {
