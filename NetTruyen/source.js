...
class DefaultScrappy extends lib_1.Source {
    ...
    getRawHtml(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield this.requestManager.schedule(req, 3);
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const section of this.getHomeSection()) {
                if (section === null || section === void 0 ? void 0 : section.url) {
                    const $doc = yield this.getRawHtml(App.createRequest({
                        url: this.siteUrl + '/' + section.url,
                        method: HTTP_METHOD.GET,
                    }));
                    sectionCallback(App.createHomeSection(Object.assign(Object.assign({}, section), { items: this.parser
    ...
    getViewMoreItems(_homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const param = { page };
            const url = (metadata === null || metadata === void 0 ? void 0 : metadata.url) || '';
            ...
            metadata = !this.parser.isLastPage($)
                ? Object.assign(Object.assign({}, metadata), { page: page + 1 }) : undefined;
    ...
    getSearchResults(_query, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            const page = (metadata === null || metadata === void 0 ? void 0 : metadata.page) || 1;
            const param = Object.assign(Object.assign({}, ((metadata === null || metadata === void 0 ? void 0 : metadata.params) || {})), { page });
            const url = (metadata === null || metadata === void 0 ? void 0 : metadata.url) || '';
            const encodedParams = Object.entries(param)
                .map(([key, val]) => `${key}=${encodeURIComponent(val)}`)
                .join('&');
...
const siteUrl = 'https://www.nettruyenclub.com';
...
class NetTruyenParser extends DefaultParser_1.DefaultParser {
    ...
    parserListManga($doc, contextBlockSelector) {
        ...
        return $doc('.item', contextBlockSelector)
            ...
            var _a, _b, _c, _d, _e;
            return {
                title: (_b = (_a = $doc('h3 a', $el)) === null || _a === void 0 ? void 0 : _a.text()) === null || _b === void 0 ? void 0 : _b.trim(),
                subtitle: (_d = (_c = $doc('.slide-caption > a, .comic-item li:first-child a', $el)) === null || _c === void 0 ? void 0 : _c.text()) === null || _d === void 0 ? void 0 : _d.trim(),
                image: this.parserImg($doc, $el),
                mangaId: (_e = $doc('a', $el).attr('href')) === null || _e === void 0 ? void 0 : _e.trim(),
            };
        })
            .toArray();
    }
    ...
    isLastPage($doc) {
        ...
        const currentPage = (_a = $doc('li.active', $root)) === null || _a === void 0 ? void 0 : _a.text();
        const nextPage = (_b = $doc('li.active + li')) === null || _b === void 0 ? void 0 : _b.text();
